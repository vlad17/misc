...
(yas-define-snippets 'emacs-lisp-mode
                     '(("yes-or-no-p" "(yes-or-no-p \"PROMPT$0 \")" "yes-or-no-p" nil nil nil nil nil nil)
                       ...
                       ("_read_me" "-*- coding: utf-8 -*-\nOriginally started by Xah Lee (xahlee.org) on 2009-02-22\nReleased under GPL 3.\n\nFeel free to add missing ones or modify existing ones to improve.\n\nThose starting with “x-” are supposed to be idiom templates. Not sure it's very useful. They might start with “i-” or \"id-\" in the future." "_read_me" nil nil nil nil nil nil)))
